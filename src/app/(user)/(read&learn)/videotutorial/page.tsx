...
const page = () => {
    ...
    return (
        <div className='pl-64 py-36 w-full h-screen'>
            {/* <div className=''> */}
            {/* <InformationImage
            ...
            {/* </div> */}
            <div>
                <h1 className='text-4xl font-bold mb-7'>Video Tutorials</h1>
            ...
            <Tabs defaultValue="videotutorial" className="flex gap-3 mt-7">
