...
const page = async ({ 
  ...
  return (
    <div className='relative '>
      ...
      <div className='w-full my-5 bg-gray-50 pb-5 px-5 shadow-sm drop-shadow-md'>
          ...
          <>
            ...
            <div className='font-livvic'>
              ...
              <div className='flex items-center justify-around my-3 '>
                <Link className='flex items-center gap-3 text-[0.6rem] sm:text-sm text-gray-500' href={'https://www.google.com/maps/dir//P428%2B79Q+New+Greenland,+Quezon+City,+Rizal/@14.700727,121.1160022,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3397bb35978a95fb:0x3748a3771671970!2m2!1d121.1159989!2d14.7007173?entry=ttu'}>
                <span className='text-red-600 text-[0.5rem] sm:text-sm'><CiLocationOn /></span> Pahinge Ng address , Quezon City
                </Link>
                <div className='flex items-center gap-3 text-[0.6rem] sm:text-sm text-gray-500'>
          ...
          <div className=''>
            ...
            <div className='font-livvic'>
              ...
              <div className='flex items-center justify-around my-1 md:my-3 '>
                <Link className='flex items-center gap-3 text-[0.5rem] sm:text-sm text-gray-500' href={'https://www.google.com/maps/dir//P428%2B79Q+New+Greenland,+Quezon+City,+Rizal/@14.700727,121.1160022,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3397bb35978a95fb:0x3748a3771671970!2m2!1d121.1159989!2d14.7007173?entry=ttu'}>
                  <span className='text-red-600 text-[0.6rem] sm:text-sm'><CiLocationOn /></span> Pahinge Ng address , Quezon City
                </Link>
                <div className='flex items-center gap-3 text-[0.5rem] sm:text-sm text-gray-500'>
              ...
              <p className='text-[0.6rem] sm:text-sm text-gray-500 pb-3'>Sharon Urban Farming, the name of community farm of barangay Nova Proper. it is currently manage by Enrique P. Añonuevo, a BESWMC Head of Sharon Urban Farming. Sharon Farm, an integrated urban farm situated at the heart of the city, was launched last June 2, 2021, with collaborative efforts and partnership between public and private stakeholders. The area owned by the Diocese of Novaliches that is approximately 5,500 square meter before the Gulayan sa Siyudad project. This program and movement aim to improve the access of urban settlers and disadvantaged groups to safe and nutritious food, promote social inclusion, and become an important means for recreation and educational activities for the community.</p>
            </div>
