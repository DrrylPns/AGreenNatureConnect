...
export default async function Markethub() {
  ...
  return (
    <div >
      ...
      <div>
      <h1 className="text-sm md:text-xl font-bold mt-3">Urban Farms:</h1>
      <BarangayDropdown />
      </div>
      <div className="my-5 flex flex-col-reverse md:flex-row md:flex justify-between items-center w-full">
        <h1 className="text-xl font-bold text-center mt-5 md:mt-0 md:text-left ">Urban Farms Products</h1>
