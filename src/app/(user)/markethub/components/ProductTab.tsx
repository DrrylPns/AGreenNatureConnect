    ...
    return (
        <div className='pb-10 h-full'>
            <Tab.Group defaultIndex={0} selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <Tab.Panels>
                    <Tab.Panel>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 mt-2 font-poppins font-medium">
                            {allProducts.length > 0 ? allProducts.map((product) => {
                                ...
                                <div className='col-span-12 flex justify-center items-center w-full h-screen text-center'>
