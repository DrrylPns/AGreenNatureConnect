...
function BarangayDropdown() {
  ...
  return (
    <Menu>
        <Menu.Button className="relative  ui-open:shadow-xl flex items-center justify-between w-full md:w-1/4 px-5 py-3 bg-white drop-shadow-sm shadow-md border border-gray-300 rounded-md">Barangay <span><BiCaretDown/></span></Menu.Button>
