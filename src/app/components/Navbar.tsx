...
export default function Navbar() {
  ...
  return (
    <nav
      className={`lg:none block fixed flex w-full z-50 justify-between px-3 py-2 min-h-[5rem] mix-h-[5rem] items-center bg-white md:px-20`}
    >
      ...
      <div className="hidden sm:block relative min-w-fit w-[30%]">
        <input
          ...
          className="hidden rounded-full w-full pl-10 py-3 bg-[#F0EEF6] sm:block"
        />
      ...
      {user ? (
        <div className="flex items-center gap-5 justify-between">
          ...
          <button className=" w-[2.5rem]">
            <Image src={DisplayPhoto} alt="User Image" />
          </button>
        </div>
      ) : (
        <div className="w-[]">
