...
export const DeclinedMaterials = () => {
  ...
  const { isLoading, isError, data: materials } = useQuery({
    ...
    queryFn: async () => {
      try {
        const { data } = await axios.get("/api/user/getMaterials/declined");
  ...
  return (
    <div className="gap-2 grid grid-cols-2 sm:grid-cols-4 mt-11">
      ...
      {materials.map((material) => (
        //@ts-ignore
        <div>{material.isApproved === "DECLINED" ? (
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                        <AlertDialogDescription>
                          This action will approve the requested material of the employee and it will be seen in the blog section .
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel className="bg-rose-500 hover:bg-rose-500/80">
