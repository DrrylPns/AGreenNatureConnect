...
import { BookOpen, FileClock, FileText, FileWarning, Home, ListChecks, LogOut, MessagesSquareIcon, PlaySquare, Settings, Speech, Store, Upload, User, Warehouse } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className='w-full border-b shadow-md'>
        <div className='grid grid-cols-8 p-3 items-center justify-center text-center lg:hidden bg-[#7ef9bf]'>
